...
Ennoia* Ennoia::updateScreen() {
  SDL_SetWindowSize(window, screenWidth, screenHeight);

  // Update default shaders
  default_shader_2d.setUniform("screensize", Vec2f(renderWidth, renderHeight));
  default_shader_3d.setUniform("projection", perspective(70 * (M_PI / 180), renderWidth / renderHeight, 0.1, 100));
